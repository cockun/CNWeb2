            ...
            <div className="row2">
              ...
              <div className="col3">
                <div className="footer-widget">
                  ...
                  <ul>
                    <li>
                      <Link to="/AccUser">My Account</Link>
                    </li>
                    <li>
                      <Link to="/Contact">Contact</Link>
                    </li>
              ...
              <div className="col4">
                ...
                <div className="newslatter-item">
                  ...
                  <div id="hcard-Nghi-Thiện-Nguyễn" class="vcard">
                    <a class="url fn n" href="http://mdsfone.xyz/home">
                      {" "}
                      <span class="given-name">Nghi</span>
                      <span class="additional-name">Thiện</span>
                      <span class="family-name">Nguyễn</span>
                    </a>
                    <div class="org">HCMUE</div>
                    <a class="email" href="mailto:nguyenthiennghi1@gmail.com">
                      nguyenthiennghi1@gmail.com
                    </a>
                    <div class="adr">
